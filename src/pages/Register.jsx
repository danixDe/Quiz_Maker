        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full py-2 pl-10 pr-3 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-secondary-500"
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-2 px-4 rounded-md font-medium text-white bg-secondary-600 hover:bg-secondary-700 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:ring-offset-2 ${
